    ...
    <div>
        ...
        <b-form @submit.prevent="validateBeforeRegister" class="form-inline">
            <fieldset id="register-fieldset" class="col-12">
                ...
                <div class="form-group col-12 row justify-content-center">
                    <label class="col-12" for="email">{{$t('email')}}</label>
                ...
                <div class="form-group col-12 row justify-content-center">
                    <label class="col-12" for="confirmPassword">{{$t('confirmPassword')}}</label>
                ...
                <div class="form-group justify-content-center text-center col-12 row custom-margin-top">
                    <b-button id="button-register" type="submit" class="col-2" variant="secondary">{{$t('register')}}</b-button>
                </div>
            </fieldset>
        </b-form>
    </div>
